...
```
```{r voom, echo=FALSE, out.width="400px", fig.cap="Figure S12: Mean variance trend for our logCPM values."}
...
```{r diagnostic1, echo=FALSE, out.width="500px", fig.cap="Figure S13: Diagnostics plots for DE analysis: distribution of p-values and qqplot."}
...
plot(pvalfreq$mids, log10(pvalfreq$counts), type = 'h', lwd = 4, lend = 2, ylim = c(0,4),
     xlab = "Raw P-values", ylab = "Log10 frequencies", main = "", las = 1, cex = 3)
...
```{r volcano1, echo=FALSE, out.width="400px", fig.cap="Figure S14: Volcano plot of the results of the DE analysis."}
par(mar = c(4, 5, 2, 2))
volcanoplot(fit, coef = 2, highlight = 7, fit$genes$symbol, main = "Model 1", las = 1,
